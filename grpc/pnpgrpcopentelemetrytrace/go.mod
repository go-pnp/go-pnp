...
require (
	...
	github.com/go-pnp/go-pnp/grpc/pnpgrpcopentelemetry v0.0.14
...
require (
	...
	github.com/go-pnp/go-pnp/grpc/pnpgrpcclient v0.1.3 // indirect
	github.com/go-pnp/go-pnp/grpc/pnpgrpcserver v0.0.10 // indirect
